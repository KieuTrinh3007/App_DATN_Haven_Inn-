...
class TienNghiPhongAdapter(var items: List<TienNghiPhongModel>) : RecyclerView.Adapter<TienNghiPhongAdapter.TienNghiViewHolder>() {
...
//        holder.binding.tvTenTienNghi.text = item.tenTienNghi
